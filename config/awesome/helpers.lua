...
function helpers.create_3d_effect_r(w, margin, amt)
    return {
        {bg = "#dadada", widget = wibox.container.background},
        {
            {
                bg = helpers.lighten("#0c0c0c", amt),
                id = 'white_border_role',
...
function helpers.create_3d_effect(w, margin, amt)
    return {
        {bg = "#dadada", widget = wibox.container.background},
        {
            {
